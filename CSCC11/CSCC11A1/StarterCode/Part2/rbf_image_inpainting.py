...
if __name__ == "__main__":
    ...
    spacing = 9 # Color on text become more close to the surrounding as spacing increases
    width = 2 # letters become less recognizable as width increases
    l2_coef = 0.5 # Image become  as l2_cof increases
    #spacing = 3
    #width = 2
    #l2_coef = 0.5
